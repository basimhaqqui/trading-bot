...
- Versioned, pre-registered hypotheses for perpetual funding/basis, options implied-volatility state, prediction-market calibration, hourly crypto range breakouts, and fifteen-minute crypto momentum.

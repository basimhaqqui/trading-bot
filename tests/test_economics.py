...
class EconomicReplayTests(unittest.TestCase):
    ...
    def test_checked_in_cost_registry_is_strict_and_versioned(self):
        ...
        self.assertEqual(registry.version, "public-shadow-costs-v16")
        self.assertEqual(len(registry.models), 20)
        ...
        v7 = registry.models[10]
        self.assertEqual(
            v7.specialist_id,
            "prediction-market-fast-settlement-baseline-v7",
        )
        self.assertEqual(v7.model_id, "kalshi-general-contract-fee-fast-v7")
        self.assertEqual(v7.binary_fee_coefficient, 0.07)
        self.assertEqual(v7.binary_fee_increment, 0.01)
        self.assertEqual(v7.slippage_bps, 5)
        self.assertEqual(v7.latency_bps, 5)
        v8 = registry.models[11]
        self.assertEqual(
            v8.specialist_id,
            "prediction-market-fast-settlement-baseline-v8",
        )
        self.assertEqual(v8.model_id, "kalshi-general-contract-fee-fast-v8")
        v9 = registry.models[12]
        self.assertEqual(
            v9.specialist_id,
        ...
        v11 = registry.models[14]
        self.assertEqual(
            v11.specialist_id,
            "prediction-market-fast-settlement-baseline-v11",
        )
        self.assertEqual(v11.model_id, "kalshi-general-contract-fee-fast-v11")
        v12 = registry.models[15]
        self.assertEqual(
            v12.specialist_id,
            "prediction-market-fast-settlement-baseline-v12",
        )
        self.assertEqual(v12.model_id, "kalshi-general-contract-fee-fast-v12")
        v13 = registry.models[16]
        self.assertEqual(
            v13.specialist_id,
            "prediction-market-fast-settlement-baseline-v13",
        )
        self.assertEqual(v13.model_id, "kalshi-general-contract-fee-fast-v13")
        v14 = registry.models[17]
        self.assertEqual(
            v14.specialist_id,
            "prediction-market-fast-settlement-baseline-v14",
        )
        self.assertEqual(v14.model_id, "kalshi-general-contract-fee-fast-v14")
        v15 = registry.models[18]
        self.assertEqual(
            v15.specialist_id,
            "prediction-market-fast-settlement-baseline-v15",
        )
        self.assertEqual(v15.model_id, "kalshi-general-contract-fee-fast-v15")
        self.assertEqual(v15.binary_fee_coefficient, 0.07)
        self.assertEqual(v15.binary_fee_increment, 0.01)
        self.assertEqual(v15.slippage_bps, 5)
        self.assertEqual(v15.latency_bps, 5)
        v16 = registry.models[19]
        self.assertEqual(
            v16.specialist_id,
            "prediction-market-fast-settlement-baseline-v16",
        )
        self.assertEqual(v16.model_id, "kalshi-general-contract-fee-fast-v16")
        self.assertEqual(v16.binary_fee_coefficient, 0.07)
        self.assertEqual(v16.binary_fee_increment, 0.01)
        self.assertEqual(v16.slippage_bps, 5)
        self.assertEqual(v16.latency_bps, 5)

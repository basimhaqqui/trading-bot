...
def render_scorecard(scorecard: DailyScorecard, output_format: str = "text") -> str:
    ...
    lines = [
        ...
        (
            ...
            "explicit_non_provisional="
            f"{scorecard.fast_prediction_eligibility.explicitly_non_provisional_markets} "
            f"provisional={scorecard.fast_prediction_eligibility.provisional_markets} "
            "provisional_flag_missing="
            f"{scorecard.fast_prediction_eligibility.missing_provisional_flag_markets} "
            "provisional_flag_invalid="
            f"{scorecard.fast_prediction_eligibility.invalid_provisional_flag_markets} "
    ...
    lines.extend(
        [
            ...
            (
                ...
                f"**{fast.explicitly_non_provisional_markets}** explicitly non-provisional "
                f"({fast.provisional_markets} provisional excluded; "
                f"{fast.missing_provisional_flag_markets} missing and "
                f"{fast.invalid_provisional_flag_markets} invalid flags observed) → "

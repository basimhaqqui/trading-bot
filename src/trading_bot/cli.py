...
def _print_shadow_research(
    ...
    print(
        ...
        f"explicit_non_provisional="
        f"{fast_prediction_eligibility.explicitly_non_provisional_markets} "
        f"provisional={fast_prediction_eligibility.provisional_markets} "
        f"provisional_flag_missing="
        f"{fast_prediction_eligibility.missing_provisional_flag_markets} "
        f"provisional_flag_invalid="
        f"{fast_prediction_eligibility.invalid_provisional_flag_markets} "
